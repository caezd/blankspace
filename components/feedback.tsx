...
const rateButtonVariants = cva(
    "inline-flex items-center gap-2 px-4 py-1 rounded-full border text-sm [&_svg]:size-4 disabled:cursor-not-allowed pill hover:bg-transparent",
    {
        variants: {
            active: {
    ...
    return (
        ...
        >
            <div className="flex flex-row items-center gap-2">
                ...
                <Link
                    href={`/docs/${url}`}
                    className={cn(rateButtonVariants(), "ml-auto gap-8 ")}
                    onClick={() => {}}
                >
                    Éditer cette page
                    <ArrowUpRight />
