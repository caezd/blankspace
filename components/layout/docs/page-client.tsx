...
export function PageFooter({ items, ...props }: FooterProps) {
    ...
    return (
        <div
            {...props}
            className={cn(
                "@container grid mb-6 p-1 rounded-lg border",
...
function FooterItem({ item, index }: { item: Item; index: 0 | 1 }) {
    ...
    return (
        <Link
            href={item.url}
            className={cn(
                "flex flex-col gap-2 p-4 rounded-md text-sm transition-colors hover:bg-card hover:text-fd-accent-foreground @max-lg:col-span-full",
                index === 1 && "text-end"
            )}
        >
            <div
    ...
    return (
        <div className="relative">
            <div
                ...
                {...props}
                className={cn(
                    "sticky pt-12 pb-2 max-xl:hidden",
                    props.className
                )}
                style={{
                    ...props.style,
            ...
            >
                <div className="flex h-full w-full flex-col pe-4">
                    {props.children}
                </div>
            </div>
        </div>
